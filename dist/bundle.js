...
/* harmony export */ });
var sliderBlock = document.querySelector('.intro-slider');
...
/* harmony export */   "loadButton": function() { return /* binding */ loadButton; }
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
/* harmony import */ var _server__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(25);


var loadButton = document.querySelector('.articles__button');
var cardsWrapper = document.querySelector('.articles__list');

var createCards = function createCards() {
  var MAX_CARDS = 5;

  if (cardsWrapper) {
    (0,_server__WEBPACK_IMPORTED_MODULE_1__.getData)('https://mocki.io/v1/a5814d24-4e22-49fc-96d1-0e9ae2952afc').then(function (data) {
      var newArray = (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(data.articles);
    ...
    var createCard = function createCard(item) {
      ...
      newCard.innerHTML = "\n\n          <p class=\"title title--small article-card__data\">".concat(item.publishedAt, "</p>\n          <p class=\"title title--medium article-card__header\">").concat(item.title, "</p>\n          <div class=\"article-card__text\">\n            <p>").concat(item.content, "</p>\n          </div>\n          <div class=\"article-card__author-wrapper\">\n            <p class=\"article-card__author\">").concat(item.author, "</p>\n          </div>\n          <a href=\"#\" class=\"article-card__link\" aria-label=\"\u0441\u0441\u044B\u043B\u043A\u0430 \u043D\u0430 \u0441\u0442\u0430\u0442\u044C\u044E\" target=\"_blank\"></a>\n\n        ");
    ...
    var fillCardsList = function fillCardsList(array) {
      ...
      var cardsToHide = document.querySelectorAll('.article-card:nth-child(n+7)');
      cardsToHide.forEach(function (item) {
        item.classList.add('is-hidden');
      });
    };

    var showCards = function showCards() {
      var hiddenCards = document.querySelectorAll('.article-card.is-hidden');
...
var _typeof = (__webpack_require__(29)["default"]);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "filterSelect": function() { return /* binding */ filterSelect; }
/* harmony export */ });
/* harmony import */ var _create_cards__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(24);
...
var filterSelect = function filterSelect() {
  if (select) {
    var onSelectChange = function onSelectChange(evt) {
      var articleItems = document.querySelectorAll('.article-card');
      var articleItemsAfterSix = document.querySelectorAll('.article-card:nth-child(n+7)');
      var articleAuthors = document.querySelectorAll('.article-card__author');
      ...
      var defaultSettings = function defaultSettings() {
        ...
        articleItemsAfterSix.forEach(function (item) {
          item.classList.add('is-hidden');
        });
        _create_cards__WEBPACK_IMPORTED_MODULE_0__.loadButton.classList.remove('is-hidden');
      };

      var hideArticles = function hideArticles() {
        articleItems.forEach(function (item) {
          item.classList.add('is-hidden');
        });
        _create_cards__WEBPACK_IMPORTED_MODULE_0__.loadButton.classList.add('is-hidden');
      };
      ...
      switch (selectedOptionValue) {
        ...
        case '1':
          hideArticles();
          articleAuthors.forEach(function (item) {
...
/* harmony import */ var _intro_slider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(23);
/* harmony import */ var _create_cards__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(24);
/* harmony import */ var _header__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(30);
/* harmony import */ var _filter_select__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(31);
...
window.addEventListener('DOMContentLoaded', function () {
  (0,_intro_slider__WEBPACK_IMPORTED_MODULE_2__.introSlider)();
  (0,_create_cards__WEBPACK_IMPORTED_MODULE_3__.createCards)();
  (0,_header__WEBPACK_IMPORTED_MODULE_4__.initHeader)();
  (0,_filter_select__WEBPACK_IMPORTED_MODULE_5__.filterSelect)();
});
}();
/******/ })()
;